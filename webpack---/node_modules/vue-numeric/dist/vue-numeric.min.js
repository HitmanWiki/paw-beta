! function(e, t) {
    ...
    return function(e) {
        ...
        t.a = {
            ...
            mounted: function() {
                var e = this;
                (this.valueNumber || this.isDeliberatelyZero()) && (this.process(this.valueNumber), this.amount = this.format(this.valueNumber), setTimeout(function() {
            ...
            methods: {
                ...
                isDeliberatelyZero: function() {
                    return 0 === this.valueNumber && "" !== this.value
                }
            }
        }
    }, function(e, t, r) {
        ...
        e.exports = function(e, t, r, n, i, u) {
            ...
            t && (l.render = t.render, l.staticRenderFns = t.staticRenderFns, l._compiled = !0), r && (l.functional = !0), i && (l._scopeId = i);
            var c;
            if (u ? (c = function(e) {
                ...
                var m = l.functional,
                    d = m ? l.render : l.beforeCreate;
                m ? (l._injectStyles = c, l.render = function(e, t) {
