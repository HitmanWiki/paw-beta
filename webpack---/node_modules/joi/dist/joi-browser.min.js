! function(e, t) {
    ...
    return function(e) {
        ...
        p.root = function() {
            ...
            extend(...e) {
                o.verifyFlat(e, "extend"), d = d || r(17), s(e.length, "You need to provide at least one extension"), this.assert(e, d.extensions);
                const t = Object.assign({}, this);
        ...
        e.exports = i.extend({
            ...
            with(e, t, r, s, n) {
                for (const a of t.peers)
                    if (void 0 === a.resolve(r, s, n, null, {
                            shadow: !1
                        })) return {
                        code: "object.with",
                        context: {
        ...
        e.exports = JSON.parse('{"version":"17.4.0"}')
    }, function(e, t, r) {
        "use strict";
        const s = {};
        e.exports = function(e) {
        ...
        t.Parser = class {
            ...
            _subFormula(e, r) {
                ...
                return a = a.map(e => new t.Parser(e, this.settings)),
                    function(e) {
                        const t = [];
        ...
        e.exports = a.extend({
                ...
                if (r._flags.match) {
                    ...
                    for (let s = 0; s < r.$_terms.matches.length; ++s) {
                        const n = r.$_terms.matches[s],
                            i = a.nest(n.schema, "match.".concat(s));
                        i.snapshot();
                        const l = n.schema.$_validate(e, i, o);
                        l.errors ? i.restore() : t.push(l.value)
                    }
                    ...
                    return r.$_terms.matches.reduce((e, t) => e && "object" === t.schema.type, !0) ? {
            ...
            for (const {
                ...
                const i = a[0];
                if (i instanceof l.Report == !1) return u.unmatched(e, t);
                        ...
                        for (let a = 0; a < this.$_terms.whens.length; ++a) {
                            ...
                            for (let c = 0; c < l.length; ++c) {
                                const {
                                    ...
                                    then: f,
                                    otherwise: m
                                } = l[c], h = "".concat(a).concat(o.switch ? "." + c : "");
        ...
        t.entry = function(e, t, r) {
            ...
            if (a.externals.length) {
                ...
                for (const {
                    ...
                    let a, i, l = e;
                    s.length && (a = s[s.length - 1], i = o(e, s.slice(0, -1)), l = i[a]);
                    try {
                        const s = await t(l, {
                            prefs: r
                        });
                        if (void 0 === s || s === l) continue;
                        i ? i[a] = s : e = s
                    } catch (e) {
                        throw e.message += " (".concat(n, ")"), e
                    }
                }
                n.value = e
            }
            ...
            rules: {
                ...
                sort: {
                    ...
                    validate(e, {
                        ...
                        if (i) return i;
                        for (let r = 0; r < e.length; ++r)
                            if (e[r] !== o[r]) return t("array.sort", {
                                order: a.order,
                ...
                uri: {
                    method(e = {}) {
                        ...
                        const {
                            regex: t,
                            scheme: r
                        } = m.regex(e), s = e.domain ? p.addressOptions(e.domain) : null;
                        return this.$_addRule({
                            name: "uri",
                            args: {
                                options: e
